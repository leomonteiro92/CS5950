		...
		<div id="list-service" class="content scaffold-list" role="main">
			...
			<thead>
					<tr>
						...
						<g:sortableColumn property="averageWaitingTime" title="${message(code: 'service.averageWaitingTime.label', default: 'Average Waiting Time')}" />
				...
				<g:each in="${serviceInstanceList}" status="i" var="serviceInstance">
					<tr class="${(i % 2) == 0 ? 'even' : 'odd'}">
						...
						<td>${fieldValue(bean: serviceInstance, field: "averageWaitingTime")}</td>
